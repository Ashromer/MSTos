...
DXF_PATH = PROJECT_ROOT / "01_REFERENCIAS" / "planos_cad" / "PERFILES ARQUITECTÓNICOS DE FACHADA.dxf"
OUTPUT_DIR = PROJECT_ROOT / "02_PROYECTO" / "01_Familias de Piezas metálicas"
...
def extract():
    print(f"Cargando archivo DXF desde: {DXF_PATH}")
    ...
    out_extracted = OUTPUT_DIR / "perfiles_extraidos.json"
    out_test = OUTPUT_DIR / "perfiles_test.json"
    ...
    print(f"\nSaved: {out_extracted.name} and {out_test.name} in {OUTPUT_DIR}")
