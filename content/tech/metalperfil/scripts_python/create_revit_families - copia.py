...
from Autodesk.Revit.DB import (
    Transaction, SaveAsOptions, XYZ, UV, Line, Plane, CurveArray, 
...
def make_curve_array(app, pts_mm):
    """Convierte puntos en líneas de Revit respetando la tolerancia ShortCurveTolerance"""
...
def create_rfa(app, family_name, type_name, vertices_mm):
    ...
    closed_pts   = list(norm) + list(reversed(off)) + [norm[0]]
